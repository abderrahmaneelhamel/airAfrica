...
<%
    ...
    List<Airport> airports = (List<Airport>) request.getSession().getAttribute("airports");
%>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3 mb-md-0">
                                    <select name="departureAirportId" class="custom-select px-4" style="height: 47px;">
                                        <option selected>Starting Location</option>
                                        <%
                                            for(Airport airport : airports){
                                        %>
                                        <option value="<%= airport.getId()%>"><%= airport.getCity()%></option>
                                        <% } %>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3 mb-md-0">
                                    <select name="arrivalAirportId" class="custom-select px-4" style="height: 47px;">
